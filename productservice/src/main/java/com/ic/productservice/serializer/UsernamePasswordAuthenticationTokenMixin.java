package com.ic.productservice.serializer;
...
public class UsernamePasswordAuthenticationTokenMixin extends UsernamePasswordAuthenticationToken {
     ...
     *
     * @param principal the principal object (usually a {@link io.jsonwebtoken.Jwt} or {@link org.springframework.security.core.userdetails.UserDetails})
