...
import com.ic.productservice.base.AbstractRestControllerTest;
...
class ProductControllerTest extends AbstractRestControllerTest {
    ...
    void givenProductUpdateRequest_WhenUpdateProductByFromAdmin_thenReturnUpdatedProduct() throws Exception {
        ...
        // When
        when(productUpdateService.updateProductById(1L, any(ProductUpdateRequest.class))).thenReturn(updatedProduct);
        ...
        // Verify
        verify(productUpdateService, times(1)).updateProductById(1L, any(ProductUpdateRequest.class));
