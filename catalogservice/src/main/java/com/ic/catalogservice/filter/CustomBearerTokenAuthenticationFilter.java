package com.ic.catalogservice.filter;

import com.ic.catalogservice.client.UserServiceClient;
import com.ic.catalogservice.model.auth.Token;
    ...
    protected void doFilterInternal(@NonNull final HttpServletRequest httpServletRequest,
        ...
        if (Token.isBearerToken(authorizationHeader)) {
            ...
            try {
                ...
                httpServletRequest.setAttribute(HttpHeaders.AUTHORIZATION, authorizationHeader);
